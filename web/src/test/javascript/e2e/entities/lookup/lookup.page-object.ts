...
export class LookupDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('TestApp.lookup.delete.question'));
...
export default class LookupComponentsPage {
  ...
  async deleteLookup() {
    ...
    expect(await lookupDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/TestApp.lookup.delete.question/);
